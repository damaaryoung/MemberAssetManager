...
<!-- Content Header (Page header) -->
    ...
    <div class="box">
        ...
        <form class="form-horizontal" action="save" th:object="${member}" method="post">
             <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="date" class="form-control" path="dob" th:field="*{dob}" name="dob" id="dob" placeholder="Date of Birth" required>
                  </div>
                </div>               
