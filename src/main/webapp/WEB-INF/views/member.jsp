...
<!-- Content Header (Page header) -->
    ...
    <div class="box">
              ...
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
				...
				<!-- loop over and print our customers -->
      			<c:forEach var="tempMember" items="${listMembers}">
       			...
       			<c:url var="updateLink" value="/member/update/${tempMember.id}">
        		
       			</c:url>

       			<!-- construct an "delete" link with customer id -->
       			<c:url var="deleteLink" value="/member/delete/ + ${tempMember.id}">
         ...
         | 			<a class="btn btn-danger" href="${deleteLink}"
         			onclick="if (!(confirm('Are you sure you want to delete this member?'))) return false"> <i class="fa fa-trash"></i></a>
        		</td>
